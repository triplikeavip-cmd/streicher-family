  ...
  return (
    <div className="min-h-screen bg-family-black px-4 py-10 md:px-10">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl md:text-2xl font-bold text-family-white text-center mb-4">{monthName}</h1>
          ...
          {cells.map((day, i) => {
            ...
            return (
              <button
                ...
                className={`min-h-[70px] sm:aspect-square sm:min-h-0 rounded-lg border p-1 text-left flex flex-col overflow-hidden ${
